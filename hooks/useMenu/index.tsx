...
import { PressableProps, ScrollView, useColorScheme } from "react-native";
...
const useMenu: useMenuType = (
  ...
  const AppMenu: AppMenuType = ({
    ...
    const childRef = useRef<PressableProps>(null);
  ...
  return [AppMenu, currentOption, closeMenu, setCurrentOption];
};
