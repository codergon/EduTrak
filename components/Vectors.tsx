...
const Vectors = {
  NoResult: ({ color, style, size = 200, isDark = false }: VectorProps) => (
    <Svg
  ...
  EmptySheet: ({ color, style, size = 200, isDark = false }: VectorProps) => (
    <>
      <Svg
  ...
  EmptyList: ({ color, style, size = 200, isDark = false }: VectorProps) => (
    <>
      <Svg
  ...
  EmptyCourse: ({ color, style, size = 200 }: VectorProps) => (
